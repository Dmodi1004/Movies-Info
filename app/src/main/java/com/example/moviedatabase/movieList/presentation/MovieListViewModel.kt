...
import com.example.moviedatabase.movieList.util.Category
...
class MovieListViewModel @Inject constructor(
    ...
    private fun getPopularMovieList(forceFetchFormRemote: Boolean) {
        viewModelScope.launch {
            _movieListState.update {
                it.copy(isLoading = true)
            }
            movieListRepository.getMovieList(
                forceFetchFormRemote,
                Category.POPULAR,
                ...
                when (result) {
                    is Resource.Error -> {
                        ...
                        Log.e("TAG", "getPopularMovieList: $movieListState", )
                    }
                    ...
                    is Resource.Success -> {
                        result.data?.let { popularList ->
                            ...
                            Log.d("TAG", "getPopularMovieList: $popularList")
                        }
                    }
    ...
    private fun getUpcomingMovieList(forceFetchFormRemote: Boolean) {
        viewModelScope.launch {
            _movieListState.update {
                it.copy(isLoading = true)
            }
